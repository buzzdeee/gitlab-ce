...
The first time you connect to GitLab, you will be asked to verify the authenticity
of the particular host. Answer `yes` to add GitLab.com to the list of
trusted hosts:
...
authenticity of GitLab.com's host again. Run the above command once more, and
