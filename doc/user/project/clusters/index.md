...
Navigate to your project's **Operations > Kubernetes**, select your cluster, and
you'll see the available applications that you can install. Helm Tiller needs to be
installed first, since it will be used to install the rest of the applications.
