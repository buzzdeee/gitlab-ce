...
module MailScheduler
  class NotificationServiceWorker
    ...
    def perform(meth, *args)
      ...
      # No-op.
      # This exception gets raised when an argument is correct (deserializeable), but it still cannot be
      # deserialized.
      # This can happen when an object has been deleted after rails passes this job to sidekiq, but before
    ...
    # If an argument is in the ActiveJob::Arguments::TYPE_WHITELIST list, it means the argument cannot be
    # deserialized. Which means there's something wrong with our code.
