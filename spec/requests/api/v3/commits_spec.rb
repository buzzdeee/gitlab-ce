...
describe API::V3::Commits do
    ...
    context 'when authenticated', 'as a master' do
      ...
      context "since optional parameter" do
        it "returns project commits since provided parameter" do
          ...
          get v3_api("/projects/#{project_id}/repository/commits?since=#{after.utc.iso8601}", user)
      ...
      context "until optional parameter" do
        it "returns project commits until provided parameter" do
          ...
          get v3_api("/projects/#{project_id}/repository/commits?until=#{before.utc.iso8601}", user)
      ...
      context "invalid xmlschema date parameters" do
        it "returns an invalid parameter error message" do
          get v3_api("/projects/#{project_id}/repository/commits?since=invalid-date", user)
      ...
      context "path optional parameter" do
        it "returns project commits matching provided path parameter" do
          ...
          get v3_api("/projects/#{project_id}/repository/commits?path=#{path}", user)
      ...
      context 'with pagination params' do
        ...
        let(:ref_name) { 'master' }
        let!(:request) do
          get v3_api("/projects/#{project_id}/repository/commits?page=#{page}&per_page=#{per_page}&ref_name=#{ref_name}", user)
        end
  ...
  describe 'POST :id/repository/commits/:sha/cherry_pick' do
    ...
    shared_examples_for 'ref cherry-pick' do
      context 'when ref exists' do
        it 'cherry-picks the ref commit' do
          post v3_api(route, current_user), branch: branch
      ...
      context 'when repository is disabled' do
        ...
        it_behaves_like '403 response' do
          let(:request) { post v3_api(route, current_user), branch: 'master' }
        end
      end
    end
    ...
    context 'when unauthenticated', 'and project is public' do
      ...
      it_behaves_like '403 response' do
        let(:request) { post v3_api(route), branch: 'master' }
      end
    end
    ...
    context 'when authenticated', 'as an owner' do
      ...
      context 'when branch does not exist' do
        it_behaves_like '404 response' do
          let(:request) { post v3_api(route, current_user), branch: 'foo' }
      ...
      context 'when commit is already included in the target branch' do
        it_behaves_like '400 response' do
          let(:request) { post v3_api(route, current_user), branch: 'markdown' }
        end
      end
    ...
    context 'when authenticated', 'as a developer' do
      ...
      context 'when branch is protected' do
        ...
        it 'returns 400 if you are not allowed to push to the target branch' do
          post v3_api(route, current_user), branch: 'feature'
  ...
  describe 'POST /projects/:id/repository/commits/:sha/comments' do
    ...
    shared_examples_for 'ref new comment' do
      context 'when ref exists' do
        it 'creates the comment' do
          post v3_api(route, current_user), note: note
      ...
      context 'when repository is disabled' do
        ...
        it_behaves_like '403 response' do
          let(:request) { post v3_api(route, current_user), note: 'My comment' }
        end
      end
    end
    ...
    context 'when unauthenticated', 'and project is public' do
      ...
      it_behaves_like '400 response' do
        let(:request) { post v3_api(route), note: 'My comment' }
      end
    end
    ...
    context 'when authenticated', 'as an owner' do
      ...
      it 'returns the inline comment' do
        post v3_api(route, current_user), note: 'My comment', path: project.repository.commit.raw_diffs.first.new_path, line: 1, line_type: 'new'
      ...
      it 'returns 400 if note is missing' do
        post v3_api(route, current_user)
