...
describe API::V3::V3::CircuitBreakers do
  ...
  describe 'GET circuit_breakers/repository_storage' do
    it 'returns a 401 for anonymous users' do
      get v3_api('/circuit_breakers/repository_storage')

      expect(response).to have_http_status(401)
    end

    it 'returns a 403 for users' do
      get v3_api('/circuit_breakers/repository_storage', user)
    ...
    it 'returns an Array of storages' do
      ...
      get v3_api('/circuit_breakers/repository_storage', admin)
    ...
    describe 'GET circuit_breakers/repository_storage/failing' do
      it 'returns an array of failing storages' do
        ...
        get v3_api('/circuit_breakers/repository_storage/failing', admin)
  ...
  describe 'DELETE circuit_breakers/repository_storage' do
    it 'clears all circuit_breakers' do
      ...
      delete v3_api('/circuit_breakers/repository_storage', admin)
