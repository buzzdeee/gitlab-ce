...
describe API::V3::V3::PipelineSchedules do
  ...
  describe 'GET /projects/:id/pipeline_schedules' do
    context 'authenticated user with valid permissions' do
      ...
      it 'returns list of pipeline_schedules' do
        get v3_api("/projects/#{project.id}/pipeline_schedules", developer)
      ...
      %w[active inactive].each do |target|
        context "when scope is #{target}" do
          ...
          it 'returns matched pipeline schedules' do
            get v3_api("/projects/#{project.id}/pipeline_schedules", developer), scope: target
    ...
    context 'authenticated user with invalid permissions' do
      it 'does not return pipeline_schedules list' do
        get v3_api("/projects/#{project.id}/pipeline_schedules", user)
    ...
    context 'unauthenticated user' do
      it 'does not return pipeline_schedules list' do
        get v3_api("/projects/#{project.id}/pipeline_schedules")
  ...
  describe 'GET /projects/:id/pipeline_schedules/:pipeline_schedule_id' do
    ...
    context 'authenticated user with valid permissions' do
      it 'returns pipeline_schedule details' do
        get v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}", developer)
      ...
      it 'responds with 404 Not Found if requesting non-existing pipeline_schedule' do
        get v3_api("/projects/#{project.id}/pipeline_schedules/-5", developer)
    ...
    context 'authenticated user with invalid permissions' do
      it 'does not return pipeline_schedules list' do
        get v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}", user)
    ...
    context 'unauthenticated user' do
      it 'does not return pipeline_schedules list' do
        get v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}")
  ...
  describe 'POST /projects/:id/pipeline_schedules' do
    ...
    context 'authenticated user with valid permissions' do
      context 'with required parameters' do
        it 'creates pipeline_schedule' do
          expect do
            post v3_api("/projects/#{project.id}/pipeline_schedules", developer),
              params
    ...
    context 'authenticated user with invalid permissions' do
      it 'does not create pipeline_schedule' do
        post v3_api("/projects/#{project.id}/pipeline_schedules", user), params
    ...
    context 'unauthenticated user' do
      it 'does not create pipeline_schedule' do
        post v3_api("/projects/#{project.id}/pipeline_schedules"), params
  ...
  describe 'PUT /projects/:id/pipeline_schedules/:pipeline_schedule_id' do
    ...
    context 'authenticated user with valid permissions' do
      it 'updates cron' do
        put v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}", developer),
          cron: '1 2 3 4 *'
    ...
    context 'authenticated user with invalid permissions' do
      it 'does not update pipeline_schedule' do
        put v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}", user)
    ...
    context 'unauthenticated user' do
      it 'does not update pipeline_schedule' do
        put v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}")
  ...
  describe 'POST /projects/:id/pipeline_schedules/:pipeline_schedule_id/take_ownership' do
    ...
    context 'authenticated user with valid permissions' do
      it 'updates owner' do
        post v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}/take_ownership", developer)
    ...
    context 'authenticated user with invalid permissions' do
      it 'does not update owner' do
        post v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}/take_ownership", user)
    ...
    context 'unauthenticated user' do
      it 'does not update owner' do
        post v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}/take_ownership")
  ...
  describe 'DELETE /projects/:id/pipeline_schedules/:pipeline_schedule_id' do
    ...
    context 'authenticated user with valid permissions' do
      it 'deletes pipeline_schedule' do
        expect do
          delete v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}", master)
        end.to change { project.pipeline_schedules.count }.by(-1)
      ...
      it 'responds with 404 Not Found if requesting non-existing pipeline_schedule' do
        delete v3_api("/projects/#{project.id}/pipeline_schedules/-5", master)
    ...
    context 'authenticated user with invalid permissions' do
      ...
      it 'does not delete pipeline_schedule' do
        delete v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}", developer)
    ...
    context 'unauthenticated user' do
      it 'does not delete pipeline_schedule' do
        delete v3_api("/projects/#{project.id}/pipeline_schedules/#{pipeline_schedule.id}")
