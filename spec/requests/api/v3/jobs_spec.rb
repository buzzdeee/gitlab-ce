...
describe API::V3::V3::Jobs do
  ...
  describe 'GET /projects/:id/jobs' do
    ...
    before do
      get v3_api("/projects/#{project.id}/jobs", api_user), query
    end
  ...
  describe 'GET /projects/:id/pipelines/:pipeline_id/jobs' do
    ...
    before do
      get v3_api("/projects/#{project.id}/pipelines/#{pipeline.id}/jobs", api_user), query
    end
  ...
  describe 'GET /projects/:id/jobs/:job_id' do
    before do
      get v3_api("/projects/#{project.id}/jobs/#{job.id}", api_user)
    end
  ...
  describe 'GET /projects/:id/jobs/:job_id/artifacts' do
    before do
      get v3_api("/projects/#{project.id}/jobs/#{job.id}/artifacts", api_user)
    end
  ...
  describe 'GET /projects/:id/artifacts/:ref_name/download?job=name' do
    ...
    def get_for_ref(ref = pipeline.ref, job_name = job.name)
      get v3_api("/projects/#{project.id}/jobs/artifacts/#{ref}/download", api_user), job: job_name
    end
  ...
  describe 'GET /projects/:id/jobs/:job_id/trace' do
    ...
    before do
      get v3_api("/projects/#{project.id}/jobs/#{job.id}/trace", api_user)
    end
  ...
  describe 'POST /projects/:id/jobs/:job_id/cancel' do
    before do
      post v3_api("/projects/#{project.id}/jobs/#{job.id}/cancel", api_user)
    end
  ...
  describe 'POST /projects/:id/jobs/:job_id/retry' do
    ...
    before do
      post v3_api("/projects/#{project.id}/jobs/#{job.id}/retry", api_user)
    end
  ...
  describe 'POST /projects/:id/jobs/:job_id/erase' do
    before do
      post v3_api("/projects/#{project.id}/jobs/#{job.id}/erase", user)
    end
  ...
  describe 'POST /projects/:id/jobs/:job_id/artifacts/keep' do
    before do
      post v3_api("/projects/#{project.id}/jobs/#{job.id}/artifacts/keep", user)
    end
  ...
  describe 'POST /projects/:id/jobs/:job_id/play' do
    before do
      post v3_api("/projects/#{project.id}/jobs/#{job.id}/play", api_user)
    end
