...
describe API::V3::V3::Runner do
  ...
  describe '/api/v4/runners' do
    describe 'POST /api/v4/runners' do
      ...
      context 'when invalid token is provided' do
        it 'returns 403 error' do
          post v3_api('/runners'), token: 'invalid'
      ...
      context 'when valid token is provided' do
        it 'creates runner with default values' do
          post v3_api('/runners'), token: registration_token
        ...
        context 'when project token is used' do
          ...
          it 'creates runner' do
            post v3_api('/runners'), token: project.runners_token
    ...
    describe 'DELETE /api/v4/runners' do
      ...
      context 'when invalid token is provided' do
        it 'returns 403 error' do
          delete v3_api('/runners'), token: 'invalid'
      ...
      context 'when valid token is provided' do
        ...
        it 'deletes Runner' do
          delete v3_api('/runners'), token: runner.token
    ...
    describe 'POST /api/v4/runners/verify' do
      ...
      context 'when invalid token is provided' do
        it 'returns 403 error' do
          post v3_api('/runners/verify'), token: 'invalid-token'
      ...
      context 'when valid token is provided' do
        it 'verifies Runner credentials' do
          post v3_api('/runners/verify'), token: runner.token
  ...
  describe '/api/v4/jobs' do
    ...
    describe 'POST /api/v4/jobs/request' do
      ...
      context 'when invalid token is provided' do
        it 'returns 403 error' do
          post v3_api('/jobs/request'), token: 'invalid'
      ...
      context 'when valid token is provided' do
        ...
        def request_job(token = runner.token, **params)
          ...
          post v3_api('/jobs/request'), new_params, { 'User-Agent' => user_agent }
        end
      end
    end
    ...
    describe 'PUT /api/v4/jobs/:id' do
      ...
      def update_job(token = job.token, **params)
        ...
        put v3_api("/jobs/#{job.id}"), new_params
      end
    end
    ...
    describe 'PATCH /api/v4/jobs/:id/trace' do
      ...
      def patch_the_trace(content = ' appended', request_headers = nil)
        ...
        Timecop.travel(job.updated_at + update_interval) do
          patch v3_api("/jobs/#{job.id}/trace"), content, request_headers
          job.reload
        end
      end
    ...
    describe 'artifacts' do
      ...
      describe 'POST /api/v4/jobs/:id/artifacts/authorize' do
        ...
        def authorize_artifacts(params = {}, request_headers = headers)
          post v3_api("/jobs/#{job.id}/artifacts/authorize"), params, request_headers
        end
      ...
      describe 'POST /api/v4/jobs/:id/artifacts' do
        context 'when artifacts are being stored inside of tmp path' do
          ...
          context 'when artifacts post request does not contain file' do
            it 'fails to post artifacts without file' do
              post v3_api("/jobs/#{job.id}/artifacts"), {}, headers_with_token
          ...
          context 'GitLab Workhorse is not configured' do
            it 'fails to post artifacts without GitLab-Workhorse' do
              post v3_api("/jobs/#{job.id}/artifacts"), { token: job.token }, {}
          ...
          context 'when setting an expire date' do
            ...
            before do
              ...
              post(v3_api("/jobs/#{job.id}/artifacts"), post_data, headers_with_token)
            end
        ...
        def upload_artifacts(file, headers = {}, accelerated = true)
          ...
          post v3_api("/jobs/#{job.id}/artifacts"), params, headers
        end
      end
      ...
      describe 'GET /api/v4/jobs/:id/artifacts' do
        ...
        def download_artifact(params = {}, request_headers = headers)
          ...
          get v3_api("/jobs/#{job.id}/artifacts"), params, request_headers
        end
      end
    end
  end
