...
describe API::V3::Features do
  ...
  describe 'GET /features' do
    ...
    it 'returns a 403 for users' do
      get v3_api('/features', user)

      expect(response).to have_http_status(403)
    end

    it 'returns the feature list for admins' do
      get v3_api('/features', admin)
  ...
  describe 'POST /feature' do
    ...
    context 'when the feature does not exist' do
      it 'returns a 401 for anonymous users' do
        post v3_api("/features/#{feature_name}")

        expect(response).to have_http_status(401)
      end

      it 'returns a 403 for users' do
        post v3_api("/features/#{feature_name}", user)
      ...
      context 'when passed value=true' do
        it 'creates an enabled feature' do
          post v3_api("/features/#{feature_name}", admin), value: 'true'
        ...
        it 'creates an enabled feature for the given Flipper group when passed feature_group=perf_team' do
          post v3_api("/features/#{feature_name}", admin), value: 'true', feature_group: 'perf_team'
        ...
        it 'creates an enabled feature for the given user when passed user=username' do
          post v3_api("/features/#{feature_name}", admin), value: 'true', user: user.username
        ...
        it 'creates an enabled feature for the given user and feature group when passed user=username and feature_group=perf_team' do
          post v3_api("/features/#{feature_name}", admin), value: 'true', user: user.username, feature_group: 'perf_team'
      ...
      it 'creates a feature with the given percentage if passed an integer' do
        post v3_api("/features/#{feature_name}", admin), value: '50'
    ...
    context 'when the feature exists' do
      ...
      context 'when feature is enabled and value=false is passed' do
        it 'disables the feature' do
          ...
          post v3_api("/features/#{feature_name}", admin), value: 'false'
        ...
        it 'disables the feature for the given Flipper group when passed feature_group=perf_team' do
          ...
          post v3_api("/features/#{feature_name}", admin), value: 'false', feature_group: 'perf_team'
        ...
        it 'disables the feature for the given user when passed user=username' do
          ...
          post v3_api("/features/#{feature_name}", admin), value: 'false', user: user.username
      ...
      context 'with a pre-existing percentage value' do
        ...
        it 'updates the percentage of time if passed an integer' do
          post v3_api("/features/#{feature_name}", admin), value: '30'
