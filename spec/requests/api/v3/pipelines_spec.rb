...
describe API::V3::V3::Pipelines do
    ...
    context 'authorized user' do
      ...
      context 'when parameter is passed' do
        %w[running pending].each do |target|
          context "when scope is #{target}" do
            ...
            it 'returns matched pipelines' do
              get v3_api("/projects/#{project.id}/pipelines", user), scope: target
        ...
        context 'when scope is finished' do
          ...
          it 'returns matched pipelines' do
            get v3_api("/projects/#{project.id}/pipelines", user), scope: 'finished'
        ...
        context 'when scope is branches or tags' do
          ...
          context 'when scope is branches' do
            it 'returns matched pipelines' do
              get v3_api("/projects/#{project.id}/pipelines", user), scope: 'branches'
          ...
          context 'when scope is tags' do
            it 'returns matched pipelines' do
              get v3_api("/projects/#{project.id}/pipelines", user), scope: 'tags'
        ...
        context 'when scope is invalid' do
          it 'returns bad_request' do
            get v3_api("/projects/#{project.id}/pipelines", user), scope: 'invalid-scope'
        ...
        HasStatus::AVAILABLE_STATUSES.each do |target|
          context "when status is #{target}" do
            ...
            it 'returns matched pipelines' do
              get v3_api("/projects/#{project.id}/pipelines", user), status: target
        ...
        context 'when status is invalid' do
          it 'returns bad_request' do
            get v3_api("/projects/#{project.id}/pipelines", user), status: 'invalid-status'
        ...
        context 'when ref is specified' do
          ...
          context 'when ref exists' do
            it 'returns matched pipelines' do
              get v3_api("/projects/#{project.id}/pipelines", user), ref: 'master'
          ...
          context 'when ref does not exist' do
            it 'returns empty' do
              get v3_api("/projects/#{project.id}/pipelines", user), ref: 'invalid-ref'
        ...
        context 'when name is specified' do
          ...
          context 'when name exists' do
            it 'returns matched pipelines' do
              get v3_api("/projects/#{project.id}/pipelines", user), name: user.name
          ...
          context 'when name does not exist' do
            it 'returns empty' do
              get v3_api("/projects/#{project.id}/pipelines", user), name: 'invalid-name'
        ...
        context 'when username is specified' do
          ...
          context 'when username exists' do
            it 'returns matched pipelines' do
              get v3_api("/projects/#{project.id}/pipelines", user), username: user.username
          ...
          context 'when username does not exist' do
            it 'returns empty' do
              get v3_api("/projects/#{project.id}/pipelines", user), username: 'invalid-username'
        ...
        context 'when yaml_errors is specified' do
          ...
          context 'when yaml_errors is true' do
            it 'returns matched pipelines' do
              get v3_api("/projects/#{project.id}/pipelines", user), yaml_errors: true
          ...
          context 'when yaml_errors is false' do
            it 'returns matched pipelines' do
              get v3_api("/projects/#{project.id}/pipelines", user), yaml_errors: false
          ...
          context 'when yaml_errors is invalid' do
            it 'returns bad_request' do
              get v3_api("/projects/#{project.id}/pipelines", user), yaml_errors: 'invalid-yaml_errors'
        ...
        context 'when order_by and sort are specified' do
          context 'when order_by user_id' do
            ...
            context 'when sort parameter is valid' do
              it 'sorts as user_id: :desc' do
                get v3_api("/projects/#{project.id}/pipelines", user), order_by: 'user_id', sort: 'desc'
            ...
            context 'when sort parameter is invalid' do
              it 'returns bad_request' do
                get v3_api("/projects/#{project.id}/pipelines", user), order_by: 'user_id', sort: 'invalid_sort'
          ...
          context 'when order_by is invalid' do
            it 'returns bad_request' do
              get v3_api("/projects/#{project.id}/pipelines", user), order_by: 'lock_version', sort: 'asc'
