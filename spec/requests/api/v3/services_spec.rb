...
describe API::V3::V3::Services do
  ...
  Service.available_services_names.each do |service|
    describe "PUT /projects/:id/services/#{service.dasherize}" do
      ...
      it "updates #{service} settings" do
        put v3_api("/projects/#{project.id}/services/#{dashed_service}", user), service_attrs
        ...
        put v3_api("/projects/#{project.id}/services/#{dashed_service}?#{event}=#{!state}", user), service_attrs
      ...
      it "returns if required fields missing" do
        ...
        put v3_api("/projects/#{project.id}/services/#{dashed_service}", user), attrs
    ...
    describe "GET /projects/:id/services/#{service.dasherize}" do
      ...
      it 'returns authentication error when unauthenticated' do
        get v3_api("/projects/#{project.id}/services/#{dashed_service}")
        expect(response).to have_http_status(401)
      end

      it "returns all properties of service #{service} when authenticated as admin" do
        get v3_api("/projects/#{project.id}/services/#{dashed_service}", admin)
      ...
      it "returns properties of service #{service} other than passwords when authenticated as project owner" do
        get v3_api("/projects/#{project.id}/services/#{dashed_service}", user)
      ...
      it "returns error when authenticated but not a project owner" do
        ...
        get v3_api("/projects/#{project.id}/services/#{dashed_service}", user2)
  ...
  describe 'POST /projects/:id/services/:slug/trigger' do
    ...
    describe 'Mattermost Service' do
      ...
      context 'no service is available' do
        it 'returns a not found message' do
          post v3_api("/projects/#{project.id}/services/idonotexist/trigger")
      ...
      context 'the service exists' do
        ...
        context 'the service is not active' do
          ...
          it 'when the service is inactive' do
            post v3_api("/projects/#{project.id}/services/#{service_name}/trigger"), params
        ...
        context 'when the project can not be found' do
          it 'returns a generic 404' do
            post v3_api("/projects/404/services/#{service_name}/trigger"), params
    ...
    describe 'Slack Service' do
      ...
      it 'returns status 200' do
        post v3_api("/projects/#{project.id}/services/#{service_name}/trigger"), token: 'token', text: 'help'
