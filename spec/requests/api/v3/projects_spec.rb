...
describe API::V3::Projects do
  ...
  describe 'POST /projects' do
    ...
    it "assigns attributes to project" do
      ...
      project.each_pair do |k, v|
        next if %i[id storage_version has_external_issue_tracker issues_enabled merge_requests_enabled wiki_enabled].include?(k)
  ...
  describe 'POST /projects/user/:id' do
    ...
    it 'assigns attributes to project' do
      ...
      expect(response).to have_gitlab_http_status(201)
      project.each_pair do |k, v|
        next if %i[id storage_version has_external_issue_tracker path].include?(k)
