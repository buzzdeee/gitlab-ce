...
describe API::V3::Internal do
  ...
  describe "GET /internal/check" do
    it do
      get v3_api("/internal/check"), secret_token: secret_token
  ...
  describe 'GET /internal/broadcast_message' do
    context 'broadcast message exists' do
      ...
      it 'returns one broadcast message'  do
        get v3_api('/internal/broadcast_message'), secret_token: secret_token
  ...
  describe 'GET /internal/broadcast_messages' do
    context 'broadcast message(s) exist' do
      ...
      it 'returns active broadcast message(s)' do
        get v3_api('/internal/broadcast_messages'), secret_token: secret_token
  ...
  describe 'GET /internal/two_factor_recovery_codes' do
    it 'returns an error message when the key does not exist' do
      post v3_api('/internal/two_factor_recovery_codes'),
  ...
  describe "GET /internal/discover" do
    it do
      get(v3_api("/internal/discover"), key_id: key.id, secret_token: secret_token)
  ...
  describe 'GET /internal/merge_request_urls' do
    ...
    it 'returns link to create new merge request' do
      get v3_api("/internal/merge_request_urls?project=#{repo_name}&changes=#{changes}"), secret_token: secret_token
    ...
    context 'with a gl_repository parameter' do
      ...
      it 'returns link to create new merge request' do
        get v3_api("/internal/merge_request_urls?gl_repository=#{gl_repository}&changes=#{changes}"), secret_token: secret_token
  ...
  #
  #     post v3_api("/internal/notify_post_receive"), valid_params
  #
  #     expect(response).to have_http_status(200)
  #   end
  #
  ...
  #       to receive(:post_receive)
  #
  #     post v3_api("/internal/notify_post_receive"), valid_wiki_params
  #
  #     expect(response).to have_http_status(200)
  #   end
  #
  ...
  def lfs_auth(key_id, project)
    post(
      v3_api("/internal/lfs_authenticate"),
      key_id: key_id,
      secret_token: secret_token,
      project: project.repository.path_to_repo
    )
